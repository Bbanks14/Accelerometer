...
import com.group2.accelerometer.features.ShareActivity
import java.io.File
...
class MainActivity : AppCompatActivity(), SensorEventListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    // Then in your onCreate method, replace the registerReceiver call with:
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            // Register broadcast receiver using helper function
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.nav_share -> { startActivity(Intent(this, ShareActivity::class.java)) }
